...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.CKTfOi88.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.CzhpLks_.mjs').then(interopDefault),
